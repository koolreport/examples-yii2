    ...
    var pivotFunctions = (function() {
        ...
        var init = function(initProp) {
            ...
            var menuItemClickListener = function(ev) {
                ...
                var fieldMenuEl = findAncestor(menuItemEl, 'krpmFieldMenu');
        ...
        var getNumRow = function() {
            ...
            for (var i=0; i<rowEls.length; i+=1)
                if (1*rowEls[i].children[0].dataset.rowLayer > 0)
                    numRow += 1;
            return numRow;
        };
        ...
        var fixColumnWidth = function() {
            ...
            columnHeaderZoneTable.style.height = columnHeaderZoneDiv.offsetHeight - 1 + 'px';
        ...
        var expandCollapseRow = function(e) {
            ...
            var td = icon.parentElement.parentElement;
        ...
        var collapseTree = function(zone, expandTree, level, td) {
            ...
            for (var i=0; i<childrenEls.length; i+=1) {
                ...
                if (! childTree || (childTree && childTree.collapse)) {
                    ...
                    var icon = childrenEl.querySelector('i.fa');
        ...
        var batchExpandCollapse = function(zone, level, expandCollapse) {
            ...
            if (expandCollapse === 'expand')
                expandCollapseIcon = 'plus';
            else if (expandCollapse === 'collapse')
                expandCollapseIcon = 'minus';
            else
                return;
            ...
            // for (var j = 0; j < levels.length; j += 1) {
                for (var i = 0; i < tds.length; i += 1) {
                    ...
                    if (icon && icon.className.indexOf(expandCollapseIcon) > -1)
                        // this['expandCollapse' + Zone](icon);
                        icon.click();
                }
            // }
            this.batchOperation = false;
        ...
        var showPage = function(pageNum) {
            ...
            for (var i=0; i<rowEls.length; i+=1) {
                ...
                var rowEl = rowEls[i]; 
                if (1*rowEl.children[0].dataset.rowLayer < 1) {
